...
class __TwigTemplate_8034ec40bf10a492a081c445aef564aed52d119237839c72d8ee1cec2f6e4232 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 62) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/system/details--plain.html.twig", "/app/web/themes/contrib/socialbase/templates/system/details--plain.html.twig");
    }
